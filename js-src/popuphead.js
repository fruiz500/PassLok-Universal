...
function resetKeys(){
	...
	masterPwd = '';
	masterPwd1Box.value = '';
	chrome.storage.session.remove("KeyStr");
	chrome.storage.session.remove("myKey");
	chrome.storage.session.remove("myEmail");
	chrome.storage.session.remove("myLockbin");
	chrome.storage.session.remove("myLock");
	chrome.storage.session.remove("myezLock");
	chrome.storage.session.remove("locDir");
	chrome.storage.session.remove("prevWebsiteName");
