...
function inviteEncrypt(){
  ...
  if(!text){							//if empty, make a backup
	...
	if(!inviteRequested){				//sets flag so action happens on next click
		...
		outNode.textContent = "The gibberish link below contains a message from me that has been encrypted with PassLok Universal, To decrypt it, do this:\r\n\r\n1. Install the PassLok Universal extension by following one of these links:\r\nChrome: https://chrome.google.com/webstore/detail/passlok-universal/lbmlbnfgnbfppkfijbbpnecpglockled\r\nFirefox: https://addons.mozilla.org/en-US/firefox/addon/passlok-universal/\r\n\r\n2. Reload your email and get back to this message.\r\n\r\n3. Click the PassLok logo above (orange key). You will be asked to supply a Password, which will not be stored or sent anywhere. You must remember the Password, but you can change it later if you want.\r\n\r\nIf your email is Gmail, Yahoo, or Outlook, you may want to install PassLok for Email instead, also available at the Chrome and Firefox stores.\r\n\r\nIf you don't use Chrome or Firefox, or don't want to install an extension, you can also open the message in PassLok Privacy, a standalone app available from https://passlok.com/app\r\n";
